...
export const ContentData: ImageObject[] = [
  ...
  { id: 9, name: 'Nail Polish', category: 'trend', path: './assets/nail-polish-coffee.jpeg' },
  { id: 10, name: 'Denim Jacket', category: 'trend', path: './assets/denim-jacket.jpg' },
  { id: 11, name: 'Kimono', category: 'explore', path: './assets/kimono.jpeg' },
  ...
  { id: 19, name: 'Blue Shoe', category: 'trend', path: './assets/blue-shoe.jpg' },
  ...
  { id: 57, name: 'Disco Hat', category: 'explore', path: './assets/disco-hat.png' },
  ...
  { id: 62, name: 'Curley Hair', category: 'trend', path: './assets/curley-hair.jpg' },
